        ...
        <div class="pb-4 lg:pb-6 border-b border-gray-100" x-show="tab === 'household'" x-cloak>
            ...
            <div x-data="{
                ...
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <label for="create_new_household" class="text-xs lg:text-sm text-gray-800 font-medium">
                ...
                <div x-show="creating" x-cloak>
                    <div class="space-y-3 lg:space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-4">
                            <div>
                                <label class="block text-xs uppercase text-gray-500 font-bold mb-1">
                            ...
                            <div>
                                <label class="block text-xs uppercase text-gray-500 font-bold mb-1">
                                    Family Name (Head) <span class="text-red-500">*</span>
                                </label>
                                <input type="text"
                        ...
                        <p class="text-xs text-gray-500 bg-sky-50 border border-sky-200 rounded-lg p-2 lg:p-3">
